...
from agent_AM.problems.vrp.state_cvrp import StateCVRP
from agent_AM.problems.vrp.state_sdvrp import StateSDVRP
from agent_AM.utils.beam_search import beam_search
...
class CVRP(object):
    ...
    def get_costs(dataset, pi):
        ...
        # 下面这几步还是检查
        # demand_with_depot 512 * 11 : 加上了出发点的demand
        d = demand_with_depot.gather(1, pi)  # 512 * 15 收集了整条路径中的demands
        # used_cap的全称是used_capacity
...
class VRPDataset(Dataset):
    ...
    # 数据集一下生成num_samples的场景，每个场景变化的都是不同点的位置
